...
with tabs[0]:
    ...
    with ctop[1]:
        ...
        show_t2_fc = st.checkbox("☑️ FC (Test 2)", True, key="t2_fc")
        show_t2_pace = st.checkbox("☑️ Allure (Test 2)", False, key="t2_pace")
        show_t2_power = st.checkbox("☑️ Puissance (Test 2)", False, key="t2_power")
